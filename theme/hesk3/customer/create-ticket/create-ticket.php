            ...
            <div class="contr">
                ...
                <form class="form form-submit-ticket ticket-create <?php echo count($_SESSION['iserror']) ? 'invalid' : ''; ?>" method="post" action="submit_ticket.php?submit=1" name="form1" id="form1" enctype="multipart/form-data">
                    <section class="form-groups">
                        ...
                        <div class="form-group error">
                            <label class="label required"><?php echo $hesklang['id']; ?>:</label>
                            <input type="text" name="id" class="form-control <?php if (in_array('id',$_SESSION['iserror'])) {echo 'isEerror';} ?>" maxlength="50" value="<?php if (isset($_SESSION['c_id'])) {echo stripslashes(hesk_input($_SESSION['c_name']));} ?>" required>
                        </div>
